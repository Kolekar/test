...
<div class="content-wrapper">
         ...
         <div class="col-xs-12">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">Administrator Profile</h3>
               </div><?php $admin = $admin[0];?>
               <!-- /.box-header -->
               <div class="box-body">
                  <table class="table table-bordered">
                     <tbody>
                        ...
                        <tr>
                           <td class="center">Account Modified : </td>
   ...
   <div class="modal fade" id="change_email" role="dialog">
    ...
    <form method="post" action="<?php echo base_url(); ?>manage/change_credentials">
