          ...
          <div class="wed-profile-pic-log-detail">
            ...
            <span id="print_profile">
              <a class="tool_tip" data-toggle="tooltip" data-placement="top"  title="Print">
                <img src="<?php echo base_url(); ?>assets/img/dot.png">
              </a>
            </span>
                    ...
                    <li class="wed-personel-main-li">
                      <ul class="wed-personel-sec-ul">
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child3">
                               <?php if($profile[0]->profile_name){ echo $profile[0]->profile_name;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                        ...
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                                <?php if($profile[0]->height){ echo $profile[0]->height;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                             <?php if($profile[0]->weight){ echo $profile[0]->weight;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                               <?php if($profile[0]->mother_tongue_name){ echo $profile[0]->mother_tongue_name;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                      ...
                      <li class="wed-personel-main-li">
                        <ul class="wed-personel-sec-ul">
                          <li class="wed-personel-sec-li">
                            ...
                            <div class="child3">
                                <?php if(!$this->session->userdata('logged_in_admin')) {
                                 if(!empty($membership) && $membership->total_mobileview>0) { ?><strong><span data-toggle="modal" data-target="#view_mob" style="cursor: pointer;">View Number</span></strong><?php } else {?><strong>Locked</strong><?php } ?></div>
                              <?php } else {  ?> <strong>Locked</strong> <?php } ?>
                            <div class="clearfix"></div>
                          </li>
                          <li class="wed-personel-sec-li">
                    ...
                    <li class="wed-personel-main-li">
                      <ul class="wed-personel-sec-ul">
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                             <?php if($profile[0]->religion_name){ echo $profile[0]->religion_name;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                               <?php if($profile[0]->caste_name){ echo $profile[0]->caste_name;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                               <?php if($profile[0]->sub_caste){ echo $profile[0]->sub_caste;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li class="wed-personel-main-li">
                      <ul class="wed-personel-sec-ul">
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                                <?php if($profile[0]->country_name){ echo $profile[0]->country_name;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                                <?php if($profile[0]->state_name){ echo $profile[0]->state_name;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                                <?php if($profile[0]->city_name){ echo $profile[0]->city_name;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li class="wed-personel-main-li">
                      <ul class="wed-personel-sec-ul">
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>  
                          <div class="child3">
                              <?php if($profile[0]->education){ echo $profile[0]->education;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                              <?php if($profile[0]->occupation){ echo $profile[0]->occupation;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li class="wed-personel-main-li">
                      <ul class="wed-personel-sec-ul">
                        ...
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                               <?php if($profile[0]->father_status){ echo $profile[0]->father_status;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                              <?php if($profile[0]->family_location){ echo $profile[0]->family_location;} else { ?></div> - <?php } ?>
                    ...
                    <li class="wed-personel-main-li">
                      <ul class="wed-personel-sec-ul">
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3"> <?php if($profile[0]->family_location){ echo $profile[0]->family_location;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3">
                               <?php if($profile[0]->mother_status){ echo $profile[0]->mother_status;} else { ?></div> - <?php } ?>
                          <div class="clearfix"></div>
                        </li>
                      </ul>
                    </li>
        ...
        <div class="modal-dialog wed-add-modal-dialogue">
          <div class="modal-content wed-add-modal-content">
            ...
            <form method="post" id="contact_form1" action="">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4> Contact Details Of <?php echo $profile[0]->profile_name; ?> (T<?php echo $profile[0]->matrimony_id; ?>)</h4>
              <p>solmate is the most Trusted,the most successfull and the only matrimony site in the world to have 100% mobile verified profiles.Call up and connect with your prospects instantly</p>
         <div class="wed-add-modal-footer">
          ...
          <div class="modal-content wed-add-modal-content">
           ...
           <!--    <p>Enter your message</p> -->
            <div class="wed-add-modal-footer">
                ...
                <textarea rows="4" cols="50" name="mail_content">I am  <?php echo $sess->profile_name; ?> (T<?php echo $sess->matrimony_id; ?>) from solmate.com ph: <?php echo $sess->phone; ?> i would like to reach out to you.please share your contact details</textarea><br/>
