...
<?php  $session=$this->session->userdata('logged_in');
 ...
 ?>
          ...
          <div class="wed-profile-banner-left">
            ...
            <div class="wed-profile-501">
              <p><?php echo $profile->age; ?> Yrs &nbsp;&nbsp;<?php echo $profile->height; ?><br>
                ...
                <br>
                <input type='text' id='prof_mob_input' class='wed-navbar-input' style="display: none;" value='<?php echo $profile->phone; ?>' name="phone">
                <span id="prof_mob_text"><?php echo $profile->phone; ?></span>
    ...
    <li>
     ...
     <div class="child3">
       <select class="wed-reg-input-select" data-parsley-trigger="change" name="body_type" required>
      ...
      <select class="wed-reg-input-select" data-parsley-trigger="change" name="complexion" required>
    ...
    <li class="wed-detail-left">
      ...
      <ul class="wed-inside-detail">
        ...
        <li>
          ...
          <div class="child3">
            <input type="text" class="wed-reg-input" name="employed_in" value="<?php echo ucwords($profile->employed_in);?>">
          </div>
          <div class="clearfix"></div>
        </li>
        <li>
...
$(document).ready(function(){
  ...
  $('.datepicker').datepicker({
    ...
    $(document).on("click",".edit_prof_btn",function() {
        //if($('#edit_form').parsley().validate()) {
