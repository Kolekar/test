        ...
        <div class="row">
          <div class="col-md-12">
			...
			<div class="wed-reg-div1">
              ...
              <ul>
                <li>
                  <textarea class="wed-reg-textarea" name="about_partner" rows="4" cols="50" placeholder="Describe your expectations"><?php echo $preferences->about_partner; ?></textarea>
                </li>
                <li>
                  <button class="wed-submit-btn1 prefs_save_btn" type="button" >Submit</button>
