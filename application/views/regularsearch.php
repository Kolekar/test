            ...
            <div class="col-md-3">
              <div class="wed-reg-search-id">
                <form method="post" id="search_form" action="<?php echo base_url();?>search/">
                    <p>Search by ID</p>
                    <input type='text' id='matr_id' class="wed-search-id-input" placeholder='SM1234567' name='matri_id'>
            ...
            <div class="col-md-9">
              <div class="wed-reg-search-content">
                <ul class="wed-reg-tab-bay">
                    ...
                    <li><a data-toggle="tab" href="#ks" id="keyword_click">Keyword Search</a></li>
