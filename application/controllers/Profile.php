 ...
 private function set_upload_badge() {   
  ...
  public function upload_badge() {
	...
	public function get_inbox_pending($my_matr_id) {
		$result = array();
		$where[] = "history.history_to = '".$my_matr_id->matrimony_id."'";
...
border-bottom-left-radius:5px;border-bottom-right-radius:20px;font-family: "Roboto", sans-serif;padding: 25px;">
				...
				<p style="color: #4d4d4d;">'.$mail_from.' has forwarded the below profile from solmate.com thinking it might interest you.</p>
				<p style="color: #4d4d4d;">Click on the member ID to view the full details of a profile. Also if you would like to view similar profiles, visit <a href="#" style="text-decoration:none;color:#c02c48;font-style:italic;font-weight:500;">solmate.com</a> and access millions of profiles of eligible brides and grooms.</p>
				<br>
...
">'.$forward_name.'</h4>
				...
				solmate.com is celebrated as the Most Trusted Matrimony Brand combining tradition and technology. A network of 15 regional portals and over 2 crore members, Catholicmatrimony has found a place in the Limca Book of Records for record number of documented marriages online.
				</div>
